...
import 'package:jlf_mobile/services/balance_user_service.dart';
...
class _PointHistoryPageState extends State<BalanceUserPage> {
  ...
  _getHistories() {
    getBalanceHistories(globals.user.tokenRedis, globals.user.id)
        .then((onValue) async {
      if (onValue == null) {
                                                  ...
                                                  children: <Widget>[
                                                      ...
                                                      child: Padding(
                                                        ...
                                                        child: globals.myText(
                                                          ...
                                                          text: 'Status:'+ histories[i].information == '0' ? 'Pending' : 'Pending', align: TextAlign.start
                                                    ...
                                                    Flexible(
                                                      child: Padding(
                                                        padding: EdgeInsets.all(10),
                                                        child: globals.myText(text: 'VIRTUAL ACCOUNT :  ' + histories[i].vacc.toString(), align: TextAlign.start),
                                                      ),
