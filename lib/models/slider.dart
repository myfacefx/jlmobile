...
List<Slider> sliderFromJson(String str) => new List<Slider>.from(json.decode(str).map((x) => Slider.fromJson(x)));

String sliderToJson(List<Slider> data) => json.encode(new List<dynamic>.from(data.map((x) => x.toJson())));
