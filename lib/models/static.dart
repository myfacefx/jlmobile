...
List<Static> staticFromJson(String str) => new List<Static>.from(json.decode(str).map((x) => Static.fromJson(x)));

String staticToJson(List<Static> data) => json.encode(new List<dynamic>.from(data.map((x) => x.toJson())));
...
class Static {
    ...
    factory Static.fromJson(Map<String, dynamic> json) => new Static(
        ...
        popUpImageUrl: json["pop_up_image_url"] == null ? null : json["pop_up_image_url"],
